...
public class RagProperties {
    ...
    @Data public static class Embedding { private String model = "text-embedding-3-small"; private int dimension = 1536; private long cacheTtlSeconds = 86400; }
    @Data public static class Retrieval { private int defaultTopK = 5; private int hybridTopK = 20; private int rrfC = 60; }
    @Data public static class Rerank { private boolean enabled = true; private String model = "openai"; }
    @Data public static class Index { private String name = "kb_chunk"; private int shards = 3; private int replicas = 1; }
